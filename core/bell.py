...
def main():
    ...
    print("  - On this IDEAL channel you see no |01> or |10>. Once a noise")
    print("    model is added they appear at the noise rate - that is the")
    print("    noise floor the detection engine measures, not broken")
    print("    entanglement.")
    print()
